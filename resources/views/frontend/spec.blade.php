    ...
    <form action="{{ route('testing') }}">
        ...
        <!---<select class="js-example-basic-multiple" name="states[]" multiple="multiple" style="width:150px">
         ...
         <form>
          ...
          <form>
            <div class="checkbox">
                      <label><input type="checkbox" value="">Dolby</label>
            </div>
            <div class="checkbox">
              <label><input type="checkbox" value="">Realtek</label>
            </div>
          </form>
        </div>
                 <div class="container">
            ...
            <form>
              <div class="checkbox">
                        <label><input type="checkbox" value="">5 Inc</label>
              </div>
              <div class="checkbox">
                <label><input type="checkbox" value="">5,5 Inc</label>
              </div>
              <div class="checkbox disabled">
                <label><input type="checkbox" value="">10 Inc</label>
              </div>
            </form>
          </div>
                <div class="container">
           ...
           <form>
             <div class="checkbox">
                       <label><input type="checkbox" value="">Singel SIM</label>
             </div>
             <div class="checkbox">
               <label><input type="checkbox" value="">Dual SIM</label>
             </div>
           </form>
         </div>
